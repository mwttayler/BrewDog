...
@Composable
fun YeastInformation(yeast: String, modifier: Modifier = Modifier) {
    Column(modifier = modifier.fillMaxWidth()) {
        Text(
            text = stringResource(id = sharedR.string.details_yeast_title),
